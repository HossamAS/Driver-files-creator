...
def driver_File_hash_part(file_dict,file_insertion_index_dict,file_length_dict):
    
    biggest_length = select_biggest_length(file_length_dict)
    file_dict,file_insertion_index_dict,file_length_dict=insert_file_attribute(file_dict,file_insertion_index_dict,file_length_dict,"Astricks",create_identical_string("*",biggest_length-file_length_dict["Astricks"]))
...
guard_region_cfg_h.insert(2,"_CFG")
guard_region_cfg_h.insert(1,"_CFG")
guard_region_priv_h.insert(2,"_PRIV")
guard_region_priv_h.insert(1,"_PRIV")



driver_c,driver_c_insertion_index,driver_c_lengths=insert_file_attribute(driver_c,driver_c_insertion_index,driver_c_lengths,"Description"," c File")
driver_h,driver_h_insertion_index,driver_h_lengths=insert_file_attribute(driver_h,driver_h_insertion_index,driver_h_lengths,"Description"," header File")
driver_cfg_c,driver_cfg_c_insertion_index,driver_cfg_c_lengths=insert_file_attribute(driver_cfg_c,driver_cfg_c_insertion_index,driver_cfg_c_lengths,"Description"," config header File")
...
driver_priv_c,driver_priv_c_insertion_index,driver_priv_c_lengths=insert_file_attribute(driver_priv_c,driver_priv_c_insertion_index,driver_priv_c_lengths,"Description"," private header File")
driver_priv_h,driver_priv_h_insertion_index,driver_priv_h_lengths=insert_file_attribute(driver_priv_h,driver_priv_h_insertion_index,driver_priv_h_lengths,"Description"," private c File")

driver__c=driver_File_hash_part(driver_c,driver_c_insertion_index,driver_c_lengths)
driver__h=driver_File_hash_part(driver_h,driver_h_insertion_index,driver_h_lengths)
driver_cfg__c=driver_File_hash_part(driver_cfg_c,driver_cfg_c_insertion_index,driver_cfg_c_lengths)
driver_cfg__h=driver_File_hash_part(driver_cfg_h,driver_cfg_h_insertion_index,driver_cfg_h_lengths)
driver_priv__c=driver_File_hash_part(driver_priv_c,driver_priv_c_insertion_index,driver_priv_c_lengths)
driver_priv__h=driver_File_hash_part(driver_priv_h,driver_priv_h_insertion_index,driver_priv_h_lengths)

current_folder_name=current_folder_name.upper()
current_folder_name=current_folder_name.replace(" ","_")
guard_region_h.insert(2,current_folder_name)
...
file_name="".join([current_folder_name,".c"])
file=open(file_name,"w")
file.write(driver__c)
file.close()
file_name="".join([current_folder_name,".h"])
file=open(file_name,"w")
file.write(driver__h)
file.close()
file_name="".join([current_folder_name,"_cfg.c"])
file=open(file_name,"w")
file.write(driver_cfg__c)
file.close()
file_name="".join([current_folder_name,"_cfg.h"])
file=open(file_name,"w")
file.write(driver_cfg__h)
file.close()
file_name="".join([current_folder_name,"_priv.c"])
file=open(file_name,"w")
file.write(driver_priv__c)
file.close()
file_name="".join([current_folder_name,"_priv.h"])
file=open(file_name,"w")
